		...
		<div className='User'>
			...
			>
				...
				<div>
					...
					<Typography component='p'>1993.02.28</Typography>
				</div>
				<div style={{ position: 'absolute', right: 30 }}>
					...
					>
						<Button style={{ color: '#fff', backgroundColor: '#1c2237' }}>
							Message
						</Button>
						<Button style={{ color: '#fff', backgroundColor: '#1c2237' }}>
							Friend
				...
				<Grid item xs>
					<List>
						<ListItem>
							...
							<ListItemText primary='Phone number' secondary='+36305451518' />
						</ListItem>
						<ListItem>
							<ListItemIcon>
								<PhoneIphoneIcon style={{ color: '#1c2237' }} />
							</ListItemIcon>
							<ListItemText primary='Mobile number' secondary='+36305451518' />
						</ListItem>
					</List>
				</Grid>
				<Grid item xs>
					<List>
						<ListItem>
							...
							<ListItemText primary='Address' secondary='Dorozsmai utca 211' />
						</ListItem>
						<ListItem>
							<ListItemIcon>
								<EmailIcon style={{ color: '#1c2237' }} />
							</ListItemIcon>
							<ListItemText primary='Email address' secondary={contextEmail} />
						</ListItem>
					</List>
				</Grid>
			</Grid>
